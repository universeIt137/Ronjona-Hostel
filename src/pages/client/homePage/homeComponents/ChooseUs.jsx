...
const ChooseUs = () => {
    return (
        <div className=" my-48 container px-4 md:px-0 md:mx-auto">
            <div className='  mb-10 '>
                <p className="text-2xl md:text-5xl hover:underline font-bold ">Why Choose Us</p>
            ...
            <div className="flex flex-col lg:flex-row  lg:gap-20">
                <div className="lg:w-1/2">
                    ...
                    <div className="relative ">
                        <img
                            className="w-full md:w-3/4 h-[70lvh] md:h-[96lvh] rounded-[20px]"
                            src="https://res.cloudinary.com/da43e0ikj/image/upload/v1735624184/samples/two-ladies.jpg"
                            alt="Main Image"
                        />
                        <img
                            className="absolute right-0 top-72 w-96 h-64  border-4 rounded-[20px] border-white hidden md:block"
                ...
                <div className="w-full lg:w-1/2 mt-6 lg:mt-10 mr-0 lg:mr-8">
                    <p className="text-xl lg:text-6xl font-semibold mb-4 text-center">WHY YOU WITH RONJONA</p>
