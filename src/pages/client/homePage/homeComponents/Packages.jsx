    ...
    return (
        <div className='container px-4 md:px-0 md:mx-auto'>
            ...
            <div className='  mb-6 font-bold flex justify-between items-center'>
                <p className="text-2xl md:text-4xl hover:underline text-main-color">Our Pakeges</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-3 ">
                <div className='rounded-xl  w-full pb-6'> 
                    <div className="relative">
                        ...
                        <TbShare3 className='absolute top-4 right-3 bg-white hover:bg-main-color hover:bg-main-color hover:bg-main-color rounded-full text-3xl p-1'></TbShare3>
                    </div>
                ...
                <div className='rounded-xl  w-full pb-6'> 
                    <div className="relative">
                        ...
                        <TbShare3 className='absolute top-4 right-3 bg-white hover:bg-main-color rounded-full text-3xl p-1'></TbShare3>
                    </div>
                    <div className='flex justify-between items-center'>
                        <div>
                            <p className='font-bold text-xl'>Lansdowne</p>
